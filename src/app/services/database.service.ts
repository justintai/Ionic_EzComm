...
// Order database
    loadOrders() {
      return this.database.executeSql(
        'SELECT o.*, i.items_id, i.name, i.stock, i.price, i.min_purc, i.promo_price, i.image FROM orders o LEFT JOIN items i ON i.items_id = o.items_id ORDER BY o.order_date DESC',
        [])
        .then((data) => {
        let order = [];
    ...
    getOrder(id) {
      return this.database.executeSql(
        'SELECT o.*, i.items_id, i.name, i.stock, i.price, i.min_purc, i.promo_price, i.image FROM orders o LEFT JOIN items i ON i.items_id = o.items_id WHERE o.order_id = ?',
        [id])
      .then((data) => {
        if(data == null) {
          return {
