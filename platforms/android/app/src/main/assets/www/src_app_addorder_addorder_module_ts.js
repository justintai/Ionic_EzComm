...
AddorderPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        ...
        providers: [_hmscore_ionic_native_hms_scan_ngx__WEBPACK_IMPORTED_MODULE_2__.HMSScan]
    })
], AddorderPageModule);
...
let AddorderPage = class AddorderPage {
    constructor(db, route, actionSheetController, toastController, platform, router, hmsScanKit) {
        this.db = db;
        this.route = route;
    ...
    scanBarCode() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            const permit = yield this.checkPermission(0);
            if (permit) {
                this.defaultViewMode();
            }
        });
    }
    checkPermission(times) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            try {
    ...
    defaultViewMode() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            const permit = yield this.checkPermission(1);
            if (permit) {
...
AddorderPage = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
